/* 
 * Supuestamente, aquí se definen las cosas de JFlex.
 * Puse el código del jflex de Pascal para que nos demos una idea de cómo
 * construir esto. Aquí http://users.csc.calpoly.edu/~gfisher/classes/330/examples/jflex/
 * hay más ejemplos acerca de este scanner.
 */
